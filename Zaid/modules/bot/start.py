...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝗗𝗘𝗣𝗟𝗢𝗣𝗘𝗥⚡", url="t.me/GOKUxUSERbot"),
            ],
            [
                InlineKeyboardButton("⚡𝗨𝗣𝗗𝗔𝗧𝗘𝗦⚡", url="t.me/GOKUxEDITION"),
            ],
            [
                InlineKeyboardButton("⚡𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡", url="t.me/GOKUxENGINE"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        await msg.reply(f" 💘𝑨𝑩 𝑻𝑼𝑴 𝑷𝑨𝑲𝑲𝑨 𝑽𝑨𝑳𝑬 Gᴏᴋᴜ X ᴜꜱᴇʀʙᴏᴛ™ 𝑩𝑬𝑻𝑬 𝑨𝑺 ❥ {user.first_name} 💨.")
